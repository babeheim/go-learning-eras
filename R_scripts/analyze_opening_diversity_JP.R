...
tar <- which(moves$name == "pd;cq;") # "Q16,C3" " #FF6200"
o <- move_to_end(1:nrow(moves), tar)
moves <- moves[o,]

tar <- which(moves$name == "qd;dp;") # "R16,D4" " #ff874b"
o <- move_to_end(1:nrow(moves), tar)
moves <- moves[o,]

tar <- which(moves$name == "pd;dd;") # "Q16,D16", " #9BC4DF"
o <- move_to_end(1:nrow(moves), tar)
moves <- moves[o,]

tar <- which(moves$name == "pd;dc;") # "Q16,D17", " #44a340"
o <- move_to_end(1:nrow(moves), tar)
moves <- moves[o,]

tar <- which(moves$name == "pd;dp;") # "Q16,D4", " #FFAF56"
o <- move_to_end(1:nrow(moves), tar)
moves <- moves[o,]
...
shadowtext(1990, 0.9, label = "Q16,D4")   # " #FFAF56"
shadowtext(1977, 0.6, label = "Q16,D17")  # " #44a340"
shadowtext(1995, 0.5, label = "Q16,D16")  # " #9BC4DF"
shadowtext(2021, 0.4, label = "R16,D4")   # " #ff874b"
shadowtext(1977, 0.4, label = "Q16,C3")   # " #FF6200"
shadowtext(1990, 0.13, label = "R16,D16") # " #46cbe5"
shadowtext(2006, 0.1, label = "R16,D17")  # " #8cc665"
