...
shadowtext(1983, 0.75, label = "Q16,D17")  # " #44a340"
shadowtext(2005, 0.6, label = "Q16,D16")  # " #9BC4DF"
shadowtext(2006, 0.25, label = "R16,D16") # " #46cbe5"
shadowtext(2006, 0.05, label = "R16,D17")  # " #8cc665"
